...
const PUNISH_PRESETS = [
  ...
  { label: 'ToS violation (Discord/Roblox)', reason: 'Confirmed Terms of Service violation — permanent ban regardless of severity. Must be escalated to SID for the cross-platform reporting record.', hb: MOD_HB + '#general-discord-conduct', escalate: [{ type: 'Discord Ban', duration: 'Permanent' }] },
  ...
  { label: 'Disclosure of classified info', reason: 'Disclosure of classified information. Staff offenders: immediate termination + permanent employment blacklist (SID referral). A permanent community ban may be applied case-by-case.', hb: MOD_HB + '#general-discord-conduct', escalate: [{ type: 'Discord Ban', duration: 'Case-by-case — up to Permanent' }] },
...
const INFRACTION_PRESETS = [
  ...
  { label: 'Disclosure of classified info', points: 6, mandatory: true, reason: 'Unauthorized disclosure of confidential information (zero-tolerance). Termination + permanent employment blacklist; permanent community ban possible case-by-case.', hb: SID_HB + '#mandatory-termination-offenses' },
  ...
  { label: 'ToS violation', points: 6, mandatory: true, reason: 'Terms of Service violation — mandatory termination plus a permanent community ban regardless of severity.', hb: SID_HB + '#mandatory-termination-offenses' },
